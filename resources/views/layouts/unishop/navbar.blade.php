...
<header class="navbar navbar-sticky">
    ...
    <form class="site-search" method="get">
        <input type="text" name="site_search" placeholder="@lang('Search...')">
        <div class="search-tools"><span class="clear-search">@lang('Clear')</span><span class="close-search"><i
    ...
    <div class="site-branding">
        <div class="inner">
            ...
            @if(file_exists(asset('img/logo.jpg')))
                <a class="site-logo" href="/"><img src="{{ asset('img/logo.jpg') }}"

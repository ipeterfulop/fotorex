<!-- Cerberus email template -->
<!-- https://tedgoas.github.io/Cerberus/ -->
<!-- rendered sections: heroimage, title, content, footer -->
@php
    $bgColor = $backgroundColor ?? '#ede9e9';
    $headColor = $headerColor ?? '#fef7f3';
@endphp
            ...
            <tr>
                <td style="background-color: #ffffff;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="padding: 20px; font-family: sans-serif; font-size: 10px; color: #555555; background-color: {{ $headColor }}">
                                <h1 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 13px; color: #333333; font-weight: bold; text-align: center">
                                    @yield('title')
                                </h1>
                            </td>
                        </tr>

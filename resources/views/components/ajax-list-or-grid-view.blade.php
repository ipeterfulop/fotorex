...
<div x-data="listOrGridView()" x-init="() => {initialize()}">
...
<script>
    function listOrGridView() {
        return {
            ...
            initialize() {
                this.$watch('sortingOption', (value) => {this.loadContent()});
                this.loadContent();
            },
            switchToList() {
            ...
            loadContent() {
                this.content = this.loaderSrc;
                if (this.pushState) {
                    history.pushState({}, 'Fotorex', this.ajaxURL);
                }
